...
def main():
    ...
    parser.add_argument("--onnx", default="assets/weights/hatsune_miku_model.stream.onnx")
    parser.add_argument("--meta", default="assets/weights/hatsune_miku_model.stream.onnx.json")
