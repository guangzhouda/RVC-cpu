...
样本数: `5`，平均时长: `11.07s`，中位时长: `11.08s`。

### 实时性能

| Engine | Budget | N | Avg ms | P95 ms | RTF | Realtime OK Count |
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| RVC GPU baseline | 250ms block | 5 | 42.67 | 45.90 | 5.86 | 5 |
| RVC CPU | 250ms block | 5 | 814.48 | 831.62 | 0.32 | 0 |
| LLVC CPU | 26ms chunk | 5 | 65.25 | 69.68 | 0.41 | 0 |

### 相对 RVC GPU baseline 的客观指标

| Candidate | N | Wave RMSE | Log-mel L1 | MCD | F0 RMSE (Hz) | F0 Corr | SI-SDR (dB) |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| RVC CPU | 5 | 0.0557 | 1.0290 | 70.26 | 378.69 | 0.810 | -13.40 |
| LLVC CPU | 5 | 0.0612 | 15.2662 | 1130.34 | 739.22 | 0.134 | -32.79 |
